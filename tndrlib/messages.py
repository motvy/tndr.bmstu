...
Или отправь корректную ссылку на свою страницу вк в формате https://vk.com/username''',
    ...
    'radius': {
        1: 'English <b>Радиус поиска</b> {} m',
        2: '<b>Радиус поиска:</b> {} м',
    },
    'places_parametrs': {
        1: 'English <b><u>Параметры подбора мест:</u></b>',
        2: '<b><u>Параметры подбора мест:</u></b>'
    },
    'empty_html': {
        1: '<i>Empty</i>',
        2: '<i>Пусто</i>',
    ...
    'ask_locate': {
        1: 'English Пришли геопозицию, используя Прикрепить>Геопозиция',
        2: 'Пришли геопозицию, используя Прикрепить>Геопозиция',
    },
    'incorrect_locate': {
        1: 'English Некорректный формат геопозиции. Пришли геопозицию, используя Прикрепить>Геопозиция',
        2: 'Некорректный формат геопозиции. Пришли геопозицию, используя Прикрепить>Геопозиция',
    },
    'ask_radius': {
        1: 'English Введи радиус поиска в метрах (целое число от 1000 до 20000)',
        2: 'Введи радиус поиска в метрах (целое число от 1000 до 20000)',
    },
    'to_place': {
        1: 'English Побробнее',
        2: 'Подробнее',
